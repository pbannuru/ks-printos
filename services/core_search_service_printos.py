...
class CoreSearchService:
    ...
    async def search(
        ...
        if reranker_response:
            ...
            columns_to_extract = ["documentID","title","catalog_number","description","contentUpdateDate","language","renderLink",
            "relevant_text","products","page_number","full_text","docLanguageLocaleMap","kz_persona","namedAsset",
            "uuid","thumbnail_url","assetGroup","source","rerank_score"]
        ...
        # --- Step 1: Handle reranker hits ---
        # if reranker_response:
        #     for response_source in reranker_response:
